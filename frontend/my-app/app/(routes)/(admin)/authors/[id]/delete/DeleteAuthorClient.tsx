// app/authors/[id]/delete/DeleteAuthorClient.tsx
"use client";
...
interface DeleteAuthorClientProps {
  authorId: string;
  authorName: string;
}

export default function DeleteAuthorClient({ authorId, authorName }: DeleteAuthorClientProps) {
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-8 w-full max-w-md">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-300">
              El autor <strong className="text-white">{authorName}</strong> ha
        ...
        <div className="mb-8">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li className="flex items-center gap-2 text-gray-300">
              <div className="w-1.5 h-1.5 bg-red-500 rounded-full"></div>
              <span>
                Si el autor está relacionado con algún libro, no es posible
                eliminar
              </span>
            </li>
          </ul>
