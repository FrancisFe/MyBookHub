...
import { Tag, PlusCircle , List, Grid3x3, Search } from "lucide-react";
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">
                  {categories.length} categorías en la biblioteca
                </p>
              </div>
            </div>
        ...
        {categories.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 mb-6">
              Comienza agregando la primera categoría a la biblioteca
            </p>
            <Link
              href="categories/new"
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-wrap gap-4 justify-center">
            <div className="px-4 py-2 bg-gray-800/50 rounded-lg">
              <span className="text-gray-400 text-sm">Total: {categories.length} categorías</span>
            </div>
            <div className="px-4 py-2 bg-gray-800/50 rounded-lg">
              <span className="text-gray-400 text-sm">Organización temática</span>
            </div>
            <div className="px-4 py-2 bg-gray-800/50 rounded-lg">
