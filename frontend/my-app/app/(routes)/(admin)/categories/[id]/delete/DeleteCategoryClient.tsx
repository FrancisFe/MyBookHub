// app/categories/[id]/delete/DeleteCategoryClient.tsx
"use client";
...
interface DeleteCategoryClientProps {
  categoryId: string;
  categoryName: string;
}

export default function DeleteCategoryClient({ categoryId, categoryName }: DeleteCategoryClientProps) {
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-8 w-full max-w-md">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-300">
              La categoría <strong className="text-white">{categoryName}</strong> ha
        ...
        <div className="mb-8">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li className="flex items-center gap-2 text-gray-300">
              <div className="w-1.5 h-1.5 bg-red-500 rounded-full"></div>
              <span>
                Si la categoría tiene un libro asociado no se podrá eliminar
              </span>
            </li>
          </ul>
        </div>
